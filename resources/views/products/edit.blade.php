    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-6">
        <form action="{{ url('products/update') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" id="image" name="image" class="border-gray-300 w-full dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" type="text" name="name" required>
